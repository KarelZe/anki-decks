...
correspondences between language and visual data. The alignment
model is based on a novel combination of <b>Convolutional Neural
Networks</b> (RCNN) over image regions, <b>bidirectional Recurrent
Neural Networks</b> over sentences, and a structured objective that
