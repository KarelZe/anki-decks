...
<b>Reprojection to high-D:</b> \(\quad
\tilde{\boldsymbol{x}}_{i}=\boldsymbol{\mu}+\boldsymbol{B}
\boldsymbol{z}_{i}\) with
\(\boldsymbol{B}=\left[\begin{array}{lll}\boldsymbol{u}_{1} &
\ldots & \boldsymbol{u}_{M}\end{array}\right]\)
