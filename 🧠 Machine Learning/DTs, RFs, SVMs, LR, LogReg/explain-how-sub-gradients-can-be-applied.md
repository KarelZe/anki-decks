...
tags: checklater, ml::08_svm, ultra
markdown: false
...
### Back
\[\operatorname{argmin}_{\mathbf{w}} \quad C \underbrace{\sum_{i=1}^{N} \max \left(0,1-y_{i} f\left(\boldsymbol{x}_{i}\right)\right)}_{\text {loss function }}+\underbrace{\|\mathbf{w}\|^{2}}_{\text {regularization }}\]<div>
</div><div>
...
</div><div>As subgradients of \(\max \left(0,1-y_{i} f\left(\mathbf{x}_{i}\right)\right)\) are:</div><div><img src="paste-32f91c27bffa66c78bba9a3f73283b74dea8518d.jpg">
</div>
</div></div>
